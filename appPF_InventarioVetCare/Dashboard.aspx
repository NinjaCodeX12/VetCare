...
<head runat="server">
    ...
    <style>
        ...
        body, html {
            ...
            padding: 0;
            overflow-x: hidden;
            background-color: #f4f6f9; /* Fondo gris claro para el contenido */
        }
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="container-fluid p-0">
            <div class="row g-0"> <div class="col-md-2 sidebar shadow">
                            ...
                            <div class="col-md-3">
                                <div class="card border-start border-4 border-primary shadow-sm h-100">
                                    <div class="card-body">
                                        ...
                                        <h2 class="fw-bold"><asp:Label ID="lblProductos" runat="server" Text="120"></asp:Label></h2>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
    ...
    <script>
        function cargarPagina(pagina) { window.location.href = pagina; }
        function mostrarInicio() { window.location.href = "Dashboard.aspx"; }
